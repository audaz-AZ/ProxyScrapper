...
╚════════════════════════════════════════════════════════════════════════════════════════════╝
                                        ...
                                        [ V2 ]
                    Tool made by @audaz#0001 / github.com/audaz-AZ
...
file.write('Proxies by audaz proxys scrapper:\n')
file.close()
...
def start(url):
    try:
        ...
        pattern_one(req)
        print(f' [+] Audaz Scrapper ~ $ ~ Scrapping proxies')
    except requests.exceptions.SSLError: print(str(url) + ' [x] SSL Error')
    except: print(str(url) + ' [+] Audaz Scrapper ~ $ ~ Random Error')
...
input(f' \n\n[/] Audaz Scrapper ~ $ ~ Total scrapped proxies: ({len(good_proxies)}) pulsa enter para cerrar la tool, los hits estan en proxies.txt')
